package com.sultanapp.moralstories.models.content;
...
public class Contents implements Parcelable {
    ...
    public Contents(String title, String subTitle, String categoryId, String imageUrl, String details, boolean isFavorite) {
        this.title = title;
